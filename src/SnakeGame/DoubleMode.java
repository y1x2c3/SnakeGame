...
public class DoubleMode extends JPanel implements KeyListener,ActionListener {
	 ...
	 ImageIcon left1=new ImageIcon("images/left1.png");
	 ImageIcon right=new ImageIcon("images/right.png");
	 ImageIcon right1=new ImageIcon("images/right1.png");
	 ImageIcon up=new ImageIcon("images/up.png");
	 ImageIcon up1=new ImageIcon("images/up1.png");
	 ImageIcon down=new ImageIcon("images/down.png");
	 ImageIcon down1=new ImageIcon("images/down1.png");
	 ImageIcon body=new ImageIcon("images/body.png");
	 ImageIcon hushe=new ImageIcon("images/hushe.png");
