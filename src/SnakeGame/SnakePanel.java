...
public class SnakePanel extends JFrame implements ActionListener {
	...
	ImageIcon background=new ImageIcon("贪吃蛇.jpg");
	ImageIcon kaishi1=new ImageIcon("按钮1.png");
	ImageIcon kaishi2=new ImageIcon("按钮2.png");
	ImageIcon kaishi3=new ImageIcon("按钮3.png");
